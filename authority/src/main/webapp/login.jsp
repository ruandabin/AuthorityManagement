...
<FORM id=adminlogin  method=post
	name=adminlogin action="${pageContext.request.contextPath}/login.page"  >
<DIV></DIV>
	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${user.username }" placeholder="   Email/Telephone" name="username" id="username"></TD>
					</TR>
					<TR>
						<TD><INPUT type="password" class=input value="${user.password }" placeholder="   Password"  name="password" id="password"/></TD>
					</TR>
